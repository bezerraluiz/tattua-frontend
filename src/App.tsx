...
import QuoteDetailsPage from "./pages/app/QuoteDetailsPage";
  ...
  return (
    <Routes>
      <Route element={<Layout />}>
        ...
        <Route
          path="/aguarde-verificacao"
          element={<AwaitEmailVerification />}
        />
        ...
        <Route element={<ProtectedRoute />}>
          ...
          <Route path="/app/orcamentos/:id" element={<QuoteDetailsPage />} />
